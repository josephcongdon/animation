const vocabulary = [
    ...
    { term:'File', definition:'', language:'java' },
    { term:'Path', definition:'', language:'java' },
    { term:'JAR File', definition:'', language:'java' },
    { term:'Dependencies', definition:'', language:'java' },
    { term:'Maven', definition:'', language:'java' },
    { term:'JUnit', definition:'', language:'java' },
    { term:'Servlets', definition:'', language:'java' },
    { term:'Tomcat', definition:'', language:'java' },
    { term:'JSP', definition:'', language:'java' },
    { term:'JSTL', definition:'', language:'java' },
    { term:'MVC', definition:'', language:'java' },
    { term:'Data Access Object (DAO)', definition:'', language:'java' },
    { term:'Cookies', definition:'', language:'java' },
    { term:'Session', definition:'', language:'java' },
    { term:'JDBC', definition:'', language:'java' },
    { term:'Hashing', definition:'', language:'java' },
    { term:'Encryption', definition:'', language:'java' },
